...
namespace GherkinSimpleParser
{
    public class GherkinObject
    {
        ...
        public List<string> ExportAsCSV(string separator)
        {
        ...
        public List<string> ExportAsCSVWithExcelFormulaWrap_FR()
        {
            return ExportAsCSVWithExcelFormulaWrap("\" & CAR(10) & \"");
        }

        public List<string> ExportAsCSVWithExcelFormulaWrap_EN()
        {
            return ExportAsCSVWithExcelFormulaWrap("\" & CHAR(10) & \"");
        }

        private List<string> ExportAsCSVWithExcelFormulaWrap(string separator)
        {
            var csv = new List<string>
            {
                "Number,GIVEN,WHEN,THEN"
